...
import static com.fiap.techchallenge2.controller.EstacionamentoController.URL_ATUALIZA;

@AutoConfigureMockMvc
@SpringBootTest
@TestInstance(Lifecycle.PER_CLASS)
class EstacionamentoAtualizaTests {
	...
	public void deveRetornarStatus400_validacoesDosCamposNullsOuVazios(String placa,
		...
		this.mockMvc
				.perform(MockMvcRequestBuilders.put(URL_ATUALIZA.replace("{placa}", placa))
						.content(request)
